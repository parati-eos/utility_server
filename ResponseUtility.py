def Response_json_to_array(data):
    ...
    stakeholders_title = data.get('gtm', {}).get('stakeholdersTitle', '')
    stakeholder_gpt = data.get('gtm', {}).get('stakeholderGPT', '')
    stakeholder_gpt_cleaned = data.get('gtm', {}).get('stakeholderGPTCleaned', '')
    stakeholder_gpt_1 = data.get('gtm', {}).get('stakeholderGPT1', '')
    stakeholder_gpt_2 = data.get('gtm', {}).get('stakeholderGPT2', '')
    stakeholder_gpt_3 = data.get('gtm', {}).get('stakeholderGPT3', '')
    stakeholder_gpt_4 = data.get('gtm', {}).get('stakeholderGPT4', '')
    stakeholder_1 = data.get('gtm', {}).get('stakeholder1', '')
    stakeholder_2 = data.get('gtm', {}).get('stakeholder2', '')
    stakeholder_3 = data.get('gtm', {}).get('stakeholder3', '')
    stakeholder_4 = data.get('gtm', {}).get('stakeholder4', '')
    benefits_1 = data.get('gtm', {}).get('benefits1', '')
    benefits_2 = data.get('gtm', {}).get('benefits2', '')
    benefits_3 = data.get('gtm', {}).get('benefits3', '')
    benefits_4 = data.get('gtm', {}).get('benefits4', '')
    customer_profile_icon_1 = data.get('gtm', {}).get('customerProfileIcon1', '')
    customer_profile_icon_2 = data.get('gtm', {}).get('customerProfileIcon2', '')
    customer_profile_icon_3 = data.get('gtm', {}).get('customerProfileIcon3', '')
    customer_profile_icon_4 = data.get('gtm', {}).get('customerProfileIcon4', '')
    customer_profile_cover_image = data.get('gtm', {}).get('customerProfileCoverImage', '')
    persona = data.get('gtm', {}).get('persona', '')
    persona_category_gpt = data.get('gtm', {}).get('personaCategoryGPT', '')
    persona_category_gpt_cleaned = data.get('gtm', {}).get('personaCategoryGPTCleaned', '')
    persona_category_gpt_1 = data.get('gtm', {}).get('personaCategoryGPT1', '')
    persona_category_gpt_2 = data.get('gtm', {}).get('personaCategoryGPT2', '')
    persona_category_gpt_3 = data.get('gtm', {}).get('personaCategoryGPT3', '')
    persona_header_1 = data.get('gtm', {}).get('personaHeader1', '')
    persona_header_2 = data.get('gtm', {}).get('personaHeader2', '')
    persona_header_3 = data.get('gtm', {}).get('personaHeader3', '')
    persona_description_1 = data.get('gtm', {}).get('personaDescription1', '')
    persona_description_2 = data.get('gtm', {}).get('personaDescription2', '')
    persona_description_3 = data.get('gtm', {}).get('personaDescription3', '')
    persona_icon_1 = data.get('gtm', {}).get('personaIcon1', '')
    persona_icon_2 = data.get('gtm', {}).get('personaIcon2', '')
    persona_icon_3 = data.get('gtm', {}).get('personaIcon3', '')
    gtm_title = data.get('gtm', {}).get('gtmTitle', '')
    gtm_overview = data.get('gtm', {}).get('gtmOverview', '')
    gtm_cover_image_landscape = data.get('gtm', {}).get('gtmCoverImageLandscape', '')
    gtm_gpt = data.get('gtm', {}).get('gtmGPT', '')
    gtm_gpt_cleaned = data.get('gtm', {}).get('gtmGPTCleaned', '')
    gtm_gpt_1 = data.get('gtm', {}).get('gtmGPT1', '')
    gtm_gpt_2 = data.get('gtm', {}).get('gtmGPT2', '')
    gtm_gpt_3 = data.get('gtm', {}).get('gtmGPT3', '')
    gtm_gpt_4 = data.get('gtm', {}).get('gtmGPT4', '')
    gtm_gpt_5 = data.get('gtm', {}).get('gtmGPT5', '')
    gtm_header_1 = data.get('gtm', {}).get('gtmHeader1', '')
    gtm_header_2 = data.get('gtm', {}).get('gtmHeader2', '')
    gtm_header_3 = data.get('gtm', {}).get('gtmHeader3', '')
    gtm_header_4 = data.get('gtm', {}).get('gtmHeader4', '')
    gtm_header_5 = data.get('gtm', {}).get('gtmHeader5', '')
    gtm_description_1 = data.get('gtm', {}).get('gtmDescription1', '')
    gtm_description_2 = data.get('gtm', {}).get('gtmDescription2', '')
    gtm_description_3 = data.get('gtm', {}).get('gtmDescription3', '')
    gtm_description_4 = data.get('gtm', {}).get('gtmDescription4', '')
    gtm_description_5 = data.get('gtm', {}).get('gtmDescription5', '')
    gtm_icon_1 = data.get('gtm', {}).get('gtmIcon1', '')
    gtm_icon_2 = data.get('gtm', {}).get('gtmIcon2', '')
    gtm_icon_3 = data.get('gtm', {}).get('gtmIcon3', '')
    gtm_icon_4 = data.get('gtm', {}).get('gtmIcon4', '')
    gtm_icon_5 = data.get('gtm', {}).get('gtmIcon5', '')
    ...
    case_study_title = data.get('caseStudy', {}).get('caseStudyTitle', '')
    case_study = data.get('caseStudy', {}).get('caseStudy', '')
    challenges = data.get('caseStudy', {}).get('challenges', '')
    solution = data.get('caseStudy', {}).get('solution', '')
    outcome = data.get('caseStudy', {}).get('outcome', '')
    case_study_cover_image = data.get('caseStudy', {}).get('caseStudyCoverImage', '')

    testimonial_1 = data.get('testimonial', {}).get('testimonial1', '')
    testimonial_name_1 = data.get('testimonial', {}).get('testimonialName1', '')
    designation_1 = data.get('testimonial', {}).get('designation1', '')
    testimonial_2 = data.get('testimonial', {}).get('testimonial2', '')
    testimonial_name_2 = data.get('testimonial', {}).get('testimonialName2', '')
    designation_2 = data.get('testimonial', {}).get('designation2', '')
    testimonial_3 = data.get('testimonial', {}).get('testimonial3', '')
    testimonial_name_3 = data.get('testimonial', {}).get('testimonialName3', '')
    designation_3 = data.get('testimonial', {}).get('designation3', '')
    testimonial_4 = data.get('testimonial', {}).get('testimonial4', '')
    testimonial_name_4 = data.get('testimonial', {}).get('testimonialName4', '')
    designation_4 = data.get('testimonial', {}).get('designation4', '')
    ...
    differentiation_title = data.get('differentiation', {}).get('differentiationTitle', '')
    differentiation_gpt = data.get('differentiation', {}).get('differentiationGPT', '')
    differentiation_gpt_cleaned = data.get('differentiation', {}).get('differentiationGPTCleaned', '')
    differentiation_gpt_1 = data.get('differentiation', {}).get('differentiationGPT1', '')
    differentiation_gpt_2 = data.get('differentiation', {}).get('differentiationGPT2', '')
    differentiation_gpt_3 = data.get('differentiation', {}).get('differentiationGPT3', '')
    differentiation_gpt_4 = data.get('differentiation', {}).get('differentiationGPT4', '')
    differentiation_gpt_5 = data.get('differentiation', {}).get('differentiationGPT5', '')
    differentiation_gpt_6 = data.get('differentiation', {}).get('differentiationGPT6', '')
    differentiation_header_1 = data.get('differentiation', {}).get('differentiationHeader1', '')
    differentiation_header_2 = data.get('differentiation', {}).get('differentiationHeader2', '')
    differentiation_header_3 = data.get('differentiation', {}).get('differentiationHeader3', '')
    differentiation_header_4 = data.get('differentiation', {}).get('differentiationHeader4', '')
    differentiation_header_5 = data.get('differentiation', {}).get('differentiationHeader5', '')
    differentiation_header_6 = data.get('differentiation', {}).get('differentiationHeader6', '')
    differentiation_1 = data.get('differentiation', {}).get('differentiation1', '')
    differentiation_2 = data.get('differentiation', {}).get('differentiation2', '')
    differentiation_3 = data.get('differentiation', {}).get('differentiation3', '')
    differentiation_4 = data.get('differentiation', {}).get('differentiation4', '')
    differentiation_5 = data.get('differentiation', {}).get('differentiation5', '')
    differentiation_6 = data.get('differentiation', {}).get('differentiation6', '')
    competition_icon_1 = data.get('differentiation', {}).get('competitionIcon1', '')
    competition_icon_2 = data.get('differentiation', {}).get('competitionIcon2', '')
    competition_icon_3 = data.get('differentiation', {}).get('competitionIcon3', '')
    competition_icon_4 = data.get('differentiation', {}).get('competitionIcon4', '')
    competition_icon_5 = data.get('differentiation', {}).get('competitionIcon5', '')
    competition_icon_6 = data.get('differentiation', {}).get('competitionIcon6', '')
    team_title = data.get('team', {}).get('teamTitle', '')
    name_1 = data.get('team', {}).get('name1', '')
    designation_title_1 = data.get('team', {}).get('designationTitle1', '')
    experience_1 = data.get('team', {}).get('experience1', '')
    linkedin_1 = data.get('team', {}).get('linkedin1', '')
    image_1 = data.get('team', {}).get('image1', '')
    name_2 = data.get('team', {}).get('name2', '')
    designation_title_2 = data.get('team', {}).get('designationTitle2', '')
    experience_2 = data.get('team', {}).get('experience2', '')
    linkedin_2 = data.get('team', {}).get('linkedin2', '')
    image_2 = data.get('team', {}).get('image2', '')
    name_3 = data.get('team', {}).get('name3', '')
    designation_title_3 = data.get('team', {}).get('designationTitle3', '')
    experience_3 = data.get('team', {}).get('experience3', '')
    linkedin_3 = data.get('team', {}).get('linkedin3', '')
    image_3 = data.get('team', {}).get('image3', '')
    name_4 = data.get('team', {}).get('name4', '')
    designation_title_4 = data.get('team', {}).get('designationTitle4', '')
    experience_4 = data.get('team', {}).get('experience4', '')
    linkedin_4 = data.get('team', {}).get('linkedin4', '')
    image_4 = data.get('team', {}).get('image4', '')
    name_5 = data.get('team', {}).get('name5', '')
    designation_title_5 = data.get('team', {}).get('designationTitle5', '')
    experience_5 = data.get('team', {}).get('experience5', '')
    linkedin_5 = data.get('team', {}).get('linkedin5', '')
    image_5 = data.get('team', {}).get('image5', '')
    name_6 = data.get('team', {}).get('name6', '')
    designation_title_6 = data.get('team', {}).get('designationTitle6', '')
    experience_6 = data.get('team', {}).get('experience6', '')
    linkedin_6 = data.get('team', {}).get('linkedin6', '')
    image_6 = data.get('team', {}).get('image6', '')

    financials_title = data.get('financialSnapshot', {}).get('financialSnapshot', '')
    financial_snapshot = data.get('financialSnapshot', {}).get('financialSnapshot', '')
    funding_ask = data.get('financialSnapshot', {}).get('fundingAsk', '')
    revenue_chart = data.get('financialSnapshot', {}).get('revenueChart', '')
    cost_chart_value = data.get('financialSnapshot', {}).get('costChartValue', '')
    use_of_funds = data.get('financialSnapshot', {}).get('useOfFunds', '')
    revenue_2019 = data.get('financialSnapshot', {}).get('revenue2019', '')
    revenue_2020 = data.get('financialSnapshot', {}).get('revenue2020', '')
    revenue_2021 = data.get('financialSnapshot', {}).get('revenue2021', '')
    revenue_2022 = data.get('financialSnapshot', {}).get('revenue2022', '')
    revenue_2023 = data.get('financialSnapshot', {}).get('revenue2023', '')
    revenue_2024 = data.get('financialSnapshot', {}).get('revenue2024', '')
    revenue_2025 = data.get('financialSnapshot', {}).get('revenue2025', '')
    revenue_2026 = data.get('financialSnapshot', {}).get('revenue2026', '')
    revenue_2027 = data.get('financialSnapshot', {}).get('revenue2027', '')
    revenue_2028 = data.get('financialSnapshot', {}).get('revenue2028', '')
    cost_2019 = data.get('financialSnapshot', {}).get('cost2019', '')
    cost_2020 = data.get('financialSnapshot', {}).get('cost2020', '')
    cost_2021 = data.get('financialSnapshot', {}).get('cost2021', '')
    cost_2022 = data.get('financialSnapshot', {}).get('cost2022', '')
    cost_2023 = data.get('financialSnapshot', {}).get('cost2023', '')
    cost_2024 = data.get('financialSnapshot', {}).get('cost2024', '')
    cost_2025 = data.get('financialSnapshot', {}).get('cost2025', '')
    cost_2026 = data.get('financialSnapshot', {}).get('cost2026', '')
    cost_2027 = data.get('financialSnapshot', {}).get('cost2027', '')
    cost_2028 = data.get('financialSnapshot', {}).get('cost2028', '')
    product_and_development = data.get('financialSnapshot', {}).get('productDevelopment', '')
    marketing_and_sales = data.get('financialSnapshot', {}).get('marketingSales', '')
    capex = data.get('financialSnapshot', {}).get('capex', '')
    business_operations = data.get('financialSnapshot', {}).get('businessOperations', '')
    team_salaries = data.get('financialSnapshot', {}).get('teamSalaries', '')
