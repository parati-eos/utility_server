...
def json_to_array(data_dict):
    ...
    team_members[0]['photo'] if len(team_members) > 0 else '',
    ...
    team_members[1]['photo'] if len(team_members) > 1 else '',
    ...
    team_members[2]['photo'] if len(team_members) > 2 else '',
    ...
    team_members[3]['photo'] if len(team_members) > 3 else '',
    ...
    team_members[4]['photo'] if len(team_members) > 4 else '',
    ...
    team_members[5]['photo'] if len(team_members) > 5 else '',
    financial_snapshot,
    revenues[0],
    revenues[1],
    revenues[2],
