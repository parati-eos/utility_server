...
def json_to_array(data_dict):
    ...
    testimonials[1]["company"] if len(testimonials) > 0 and testimonials[0] != '' else '',
    ...
    testimonials[2]["company"] if len(testimonials) > 0 and testimonials[0] != '' else '',
    ...
    testimonials[3]["company"] if len(testimonials) > 0 and testimonials[0] != '' else '',
